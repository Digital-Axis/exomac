...
const Video = () => {
    ...
    return (
        <div className="video-section section section-padding overlay-two" style={{backgroundImage: `url(${process.env.PUBLIC_URL}/images/bg/video-bg1.jpg)`}}>
            ...
            <div className="container text-center">
                ...
                <SectionTitle
                    ...
                    title="“Our Printers in Action."
                />

                <button className="play-btn icon video-popup" onClick={()=> setOpen(true)}><i className="fas fa-play"></i></button>
                <ModalVideo channel='youtube' autoplay isOpen={isOpen} videoId="BDZqcgolTaE" onClose={() => setOpen(false)}/>
